...
let inputSL = await tp.system.prompt("Introduce el Nivel de Seguridad Objetivo (1-4)", "4");
let targetSL = parseInt(inputSL);
if (isNaN(targetSL) || targetSL < 1 || targetSL > 4) { targetSL = 4; }
-%>
---
tags:
  - auditoria
...
# IEC 62443-4-2: Plantilla de Evidencias - <% tp.file.title %>

> [!DANGER] INSTRUCCIONES
> **Nivel de Seguridad Objetivo:** SL<% targetSL %>
> Esta nota se ha generado dinámicamente para mostrar solo los controles hasta el nivel seleccionado.
